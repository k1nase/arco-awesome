...
theme.weather = lain.widget.weather({
    city_id = 3034005, -- placeholder (Beauvais)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow(theme.bg_normal, "alpha"),
          --  arrow("alpha", theme.fg_focus),
--            arrow("#7197E7", "#A77AC4"),
...
--            arrow("#A77AC4", "#7197E7"),
--            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), theme.bg_focus),
  --          arrow(theme.bg_focus, "alpha"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "alpha"),
--            arrow("#A77AC4", "#7197E7"),
...
--            arrow("#7197E7", "#A77AC4"),
  --          wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#A77AC4"),
        --    arrow(theme.fg_focus, "alpha"),
            arrow("alpha", theme.fg_focus),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), theme.fg_focus),
  --          arrow("#7197E7", "#A77AC4"),
--            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#A77AC4"),
            arrow(theme.fg_focus, "alpha"),
    --        arrow("alpha", theme.fg_focus),
            wibox.container.background(wibox.container.margin(wibox.widget {theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "alpha"),
      --      arrow(theme.fg_focus, "alpha"),
            arrow("alpha", theme.fg_focus),
            wibox.container.background(wibox.container.margin(clock, 4, 8), theme.fg_focus),
            arrow(theme.fg_focus, "alpha"),
    --        arrow("alpha", theme.fg_focus),
            --]]
            s.mylayoutbox,
