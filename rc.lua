...
--        {description = "rofi theme selector", group = "super"}),
    ...
    awful.key({ modkey }, "Escape", function () awful.util.spawn( "xkill" ) end,
     ...
     awful.key({ modkey }, "f", function () awful.util.spawn( "pcmanfm" ) end,
        {description = "pcmanfm", group = "hotkeys"}),
...
--    awful.key({ modkey, "Shift" }, "y", function () lain.util.delete_tag() end,
  --            {description = "delete tag", group = "tag"}),
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn(terminal) end,
              {description = terminal, group = "super"}),
    awful.key({ modkey1, "Shift" }, "r", awesome.restart,
    ...
    awful.key({ altkey   }, "=",     function () awful.tag.incnmaster( 1, nil, true) end,
...
awful.rules.rules = {
    ...
    { rule = { class = "discord" },
      properties = { tag = awful.util.tagnames[7], switchtotag = true  } },
...
--Add a titlebar on floating clients
...
--Disable titlebar on maximized clients
